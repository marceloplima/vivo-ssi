...
@Entity
@Cacheable
@Table(name="CompradoresLP2ro", schema="compras")
public class CompradoresLP2ro implements Serializable {


	/**
	 * 
	 */
	private static final long serialVersionUID = 1126535626609598488L;
	...
	private Participantes participantecompradorlp2ro;
	...
	public CompradoresLP2ro() {
		participantecompradorlp2ro = new Participantes();
	...
	public Participantes getParticipantecompradorlp2ro() {
		return participantecompradorlp2ro;
	}

	public void setParticipantecompradorlp2ro(Participantes participantecompradorlp2ro) {
		this.participantecompradorlp2ro = participantecompradorlp2ro;
	}
	...
	public boolean equals(Object obj) {
		CompradoresLP2ro objint = (CompradoresLP2ro)obj;
