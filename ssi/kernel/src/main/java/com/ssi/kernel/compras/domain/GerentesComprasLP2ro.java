...
@Entity
@Cacheable
@Table(name="GerentesComprasLP2ro", schema="compras")
public class GerentesComprasLP2ro implements Serializable {


	/**
	 * 
	 */
	private static final long serialVersionUID = -898207170698879007L;
	...
	private Participantes participantegercomplp2ro;	
	...
	public Participantes getParticipantegercomplp2ro() {
		return participantegercomplp2ro;
	}

	public void setParticipantegercomplp2ro(Participantes participantegercomplp2ro) {
		this.participantegercomplp2ro = participantegercomplp2ro;
	}
	...
	public boolean equals(Object obj) {
		GerentesComprasLP2ro objint = (GerentesComprasLP2ro)obj;
