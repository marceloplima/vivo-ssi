...
public class DemandasDataModel extends ExtendedDataModel<DemandasRedes> implements java.io.Serializable, Arrangeable {
    ...
    public DemandasDataModel(DemandasRedesInt demandaint, Map<String,Object>filtros) {
        super();
    ...
    public void walk(FacesContext context, DataVisitor visitor, Range range, Object argument) {
		...
		List<DemandasRedes>data = demandaint.retornarPaginado(firstRow, numberOfRows, filtros);
		
        for (DemandasRedes t : data) {
    ...
    @Override
    public DemandasRedes getRowData() {
...
//    	else{
	...
	public Long getId(Object obj) {
		DemandasRedes d = (DemandasRedes)obj;
