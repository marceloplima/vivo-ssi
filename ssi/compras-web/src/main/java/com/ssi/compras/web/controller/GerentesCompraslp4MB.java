...
@ManagedBean
@ViewScoped
public class GerentesCompraslp4MB implements java.io.Serializable{
	

	/**
	 * 
	 */
	private static final long serialVersionUID = 1710654361181718271L;

	private final Integer idpapel = 19;
	...
	public void definir(){
		...
		getParticipante().getGerentecompralp4().setParticipantegercomplp4(participante);
