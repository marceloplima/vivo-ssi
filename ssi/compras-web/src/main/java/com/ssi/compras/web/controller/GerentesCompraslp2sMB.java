...
@ManagedBean
@ViewScoped
public class GerentesCompraslp2sMB implements java.io.Serializable{
	

	/**
	 * 
	 */
	private static final long serialVersionUID = -3477189910373323642L;

	private final Integer idpapel = 17;
	...
	public void definir(){
		...
		getParticipante().getGerentecompralp2s().setParticipantegercomplp2s(participante);
