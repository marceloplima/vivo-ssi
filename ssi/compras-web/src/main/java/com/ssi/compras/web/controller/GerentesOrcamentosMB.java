...
@ManagedBean
@ViewScoped
public class GerentesOrcamentosMB implements java.io.Serializable{
	...
	private final Integer idpapel = 4;
	...
	public void definir(){
		...
		getParticipante().getGerenteorcamento().setParticipantegerorca(participante);
