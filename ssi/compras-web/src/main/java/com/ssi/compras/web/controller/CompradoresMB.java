...
@ManagedBean
@ViewScoped
public class CompradoresMB implements java.io.Serializable{

	/**
	 * 
	 */
	private static final long serialVersionUID = 7048195437486616025L;

	private final Integer idpapel = 7;
	...
	public void definir(){
		...
		getParticipante().getComprador().setParticipantecomprador(participante);
