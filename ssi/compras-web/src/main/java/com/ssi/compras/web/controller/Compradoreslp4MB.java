...
@ManagedBean
@ViewScoped
public class Compradoreslp4MB implements java.io.Serializable{
	 ...
	 * 
	 */
	private static final long serialVersionUID = -1523796322539003250L;

	private final Integer idpapel = 15;
	...
	public void definir(){
		...
		getParticipante().getCompradorlp4().setParticipantecompradorlp4(participante);
