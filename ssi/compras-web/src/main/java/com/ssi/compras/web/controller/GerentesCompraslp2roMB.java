...
@ManagedBean
@ViewScoped
public class GerentesCompraslp2roMB implements java.io.Serializable{
	

	/**
	 * 
	 */
	private static final long serialVersionUID = -3326805721676037005L;

	private final Integer idpapel = 16;
	...
	public void definir(){
		...
		getParticipante().getGerentecompralp2ro().setParticipantegercomplp2ro(participante);
