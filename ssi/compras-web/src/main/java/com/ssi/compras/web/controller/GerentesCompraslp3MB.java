...
@ManagedBean
@ViewScoped
public class GerentesCompraslp3MB implements java.io.Serializable{
	

	/**
	 * 
	 */
	private static final long serialVersionUID = -5161622044104347758L;

	private final Integer idpapel = 18;
	...
	public void definir(){
		...
		getParticipante().getGerentecompralp3().setParticipantegercomplp3(participante);
