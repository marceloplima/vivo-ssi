...
@ManagedBean
@ViewScoped
public class GerentesContratosMB implements java.io.Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 3052402516348532578L;
	
	private final Integer idpapel = 10;
	...
	public void definir(){
		...
		getParticipante().getGerentecontrato().setParticipantegerentecontrato(participante);
