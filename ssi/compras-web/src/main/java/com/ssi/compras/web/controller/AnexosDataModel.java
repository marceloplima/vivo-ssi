...
public class AnexosDataModel extends ExtendedDataModel<Anexos> implements java.io.Serializable, Arrangeable {
	
	private static final long serialVersionUID = 2586709813235771057L;
    ...
    public void walk(FacesContext context, DataVisitor visitor, Range range, Object argument) {
		...
		List<Anexos>data = anexoint.retornarPaginado(firstRow, numberOfRows, filtros);
