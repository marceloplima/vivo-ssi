...
@ManagedBean
@ViewScoped
public class AnalistasOrcaMB implements java.io.Serializable{
	
	
	/**
	 * 
	 */
	private static final long serialVersionUID = -3655069245639424219L;

	private final Integer idpapel = 5;
	...
	public void definir(){
		...
		getParticipante().getAnalistaorcamento().setParticipanteanalorca(participante);
