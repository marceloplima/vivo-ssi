...
public class UploadBean {
    ...
    public void submit() {
    	...
    	TiposAnexos tipoanexo = anexosint.recuperarTipoAnexo(new Long(switchtipoupload));
    	...
    	switch(switchtipoupload){
	    	case 1: // Minuta
	        	...
	        	Anexos ultimaminuta = anexosint.retornarUltimaMinutaDemanda(demanda);
    ...
    public void incluirAnexo(String caminho, TiposAnexos tipoanexo, String versao){
    	Anexos anexoincluir = new Anexos();
