...
@ManagedBean
@ViewScoped
public class Compradoreslp2roMB implements java.io.Serializable{
	...
	private final Integer idpapel = 13;
	...
	public void definir(){
		...
		getParticipante().getCompradorlp2ro().setParticipantecompradorlp2ro(participante);
