...
@ManagedBean
@ViewScoped
public class Compradoreslp2sMB implements java.io.Serializable{

	/**
	 * 
	 */
	private static final long serialVersionUID = 6546943778623073547L;

	private final Integer idpapel = 12;
	...
	public void definir(){
		...
		getParticipante().getCompradorlp2s().setParticipantecompradorlp2s(participante);
